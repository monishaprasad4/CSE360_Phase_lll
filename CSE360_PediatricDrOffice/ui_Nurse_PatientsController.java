...
public class ui_Nurse_PatientsController {
    ...
    public ui_Nurse_PatientsController() {
    ...
    private void menuBarClick_Appointments() throws Exception {
    	System.out.println("Nurse Patients - Menu Bar Click - Appointments");
    ...
    private void menuBarClick_Patients() throws Exception {
    	System.out.println("Nurse Patients - Menu Bar Click - Patients");
    ...
    private void menuBarClick_Messages() throws Exception {
    	System.out.println("Nurse Patients - Menu Bar Click - Messages");
