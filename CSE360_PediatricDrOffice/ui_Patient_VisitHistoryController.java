...
public class ui_Patient_VisitHistoryController {
	...
	@FXML
	private Menu menuBar_Account;
	@FXML
	private Menu menuBar_VisitHistory;
	@FXML
	private Menu menuBar_Messages;
	@FXML
	private Menu menuBar_ScheduleAppt;
	@FXML
	private Menu menuBar_Doctors;
	...
	private void onMouseClickListViewHandler(MouseEvent event) throws Exception {
		...
		System.out.println("Patient Visit History - list view click action handler - currentSelectionIndex: "
